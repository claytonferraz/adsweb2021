            ...
            <div class="list-group-item">
                <div class="d-flex">
                    <div class="mr-auto p-2">
                        <h2 class="display-4 titulo">Adicionar Termômetros</h2>
                    </div>
                    <a href="listarTermometro.php">
                        <div class="p-2">
                ...
                <form action="cadastrar/CadTermometro.php" method="post">
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label>
                                Código
                            </label>
                            <input name="cod" type="text" class="form-control" id="cod" placeholder="Código do Termômetro" required />
                        </div>
                        <div class="form-group col-md-4">
                            <label>
                                Temperatura Mínimo
                            </label>
                            <input name="t_minimo" type="text" class="form-control" id="t_minimo" placeholder="Limite Mínimo" required />
                        </div>
                        <div class="form-group col-md-4">
                            <label>
                                Temperatura Máximo
                            </label>
                            <input name="t_maximo" type="text" class="form-control" id="t_maximo" placeholder="Limite Máximo" required />
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label>
                                <span class="text-primary">*</span> Umidade Mínimo
                            </label>
                            <input name="u_minimo" type="text" class="form-control" id="u_minimo" placeholder="Limite Mínimo" />
                        </div>
                        <div class="form-group col-md-4">
                            <label>
                                <span class="text-primary">*</span> Umidade Máximo
                            </label>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input name="descricao" type="text" class="form-control" id="descricao" placeholder="Ex. Freezer Vertical CocaCola" required/>
                        </div>
                    </div>
                    <p>
