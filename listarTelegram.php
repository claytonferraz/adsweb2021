...
$sql = "SELECT chat_id, nome FROM telegram WHERE fk_cliente_cnpj='$cnpj'";
                ...
                <div class="list-group-item">
                    <div class="d-flex">
                        <div class="mr-auto p-2">
                            <h2 class="display-4 titulo">Listar Telegram</h2>
                        </div>
                        <a href="addChaID.php">
                            <div class="p-2">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th class="d-nome d-sm-table-cell">Chat ID</th>
                                    <th>Nome</th>
                            ...
                            <tbody><?php while($row = mysqli_fetch_assoc($resultado)) {?>
                                <tr>
                                    <td> <?php $chat = $row['chat_id']; echo $chat ?></td>
                                    <td><?php echo $row['nome'] ?></td>
                                    <td class="text-center">
                                        <span class="d-none d-md-block">
                                            <a href="editarChatID.php?chat=<?php echo $chat ?>" class="btn btn-outline-primary btn-sm">Editar</a>
                                            <a href="apagar/excluirTelegram.php?chat=<?php echo $chat ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Tem certeza da exclusão deste ChatID?')">Apagar</a>
                                        </span>
                                        <div class="dropdown d-block d-md-none">
                                            ...
                                            <div class="dropdown-menu  dropdown-menu-right" aria-labelledby="acaoListar">
                                                <a class="dropdown-item" href="editarChatID.php?chat=<?php echo $chat ?>">Editar</a>
                                                <a class="dropdown-item" href="apagar/excluirTelegram.php?chat=<?php echo $chat ?>" onclick="return confirm('Tem certeza da exclusão deste ChatID?')">Apagar</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Tem certeza que deseja excluir conta do Telegram selecionada?
                    </div>
