            ...
            <div class="list-group-item">
                <div class="d-flex">
                    <div class="mr-auto p-2">
                        <h2 class="display-4 titulo">Adicionar Usuários</h2>
                    </div>
                ...
                <form action="cadastrar/CadUsuario.php" method="post">
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label>CPF</label>
                            <input name="cpf" type="text" class="form-control" id="cpf" placeholder="Somente Números" required onkeypress="$(this).mask('000.000.000-00');">
                        </div>
                        <div class="form-group col-md-4">
                            <label>Senha</label>
                            <input name="senha" type="password" class="form-control" id="senha" placeholder="Mínimo de 6 Caracter">
                        </div>
                        <div class="form-group col-md-4">
                            <label>Confirmação</label>
                            <input name="confima" type="password" class="form-control" id="confimaSenha" placeholder="Informe a Mesma Senha" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label>Nome</label>
                            <input name="nome" type="text" class="form-control" id="nome" placeholder="Somente o Primeiro Nome" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Sobrenome</label>
                            <input name="sobrenome" type="text" class="form-control" id="sobrenome" placeholder="Restante do Nome">
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <select name="permissao" class="form-control" required>
                                ...
                                $permissao = mysqli_query($con, $sql);
                                while($row = mysqli_fetch_assoc($permissao))
                                {
