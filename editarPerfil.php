    ...
    <div class="d-flex">
        ...
        <div class="content p-1">
            <div class="list-group-item">
                ...
                <form action="editar/editarPerfil.php" method="post">
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label>CPF</label>
                            <input readonly value="<?php echo $cpf?>" name="cpf" type="text" class="form-control" id="cpf" required placeholder="Somente Números" />
                        </div>
                        <div class="form-group col-md-4">
                            <label>Senha</label>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label>Nome</label>
                            <input value="<?php echo $nome?>" name="nome" type="text" class="form-control" id="nome" required placeholder="Somente o Primeiro Nome">
                        </div>
