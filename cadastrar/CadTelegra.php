...
/*
    ...
    */
    if(isset($_POST['id']) && isset($_POST['nome']))
    {
        ...
        {
            echo "<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=https://termonline.com.br/admin/addChaID.php'>
        ...
        {
            echo "
        <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=https://termonline.com.br/admin/addChaID.php'>
