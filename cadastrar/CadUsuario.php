...
/*
    ...
    */
    if(isset($_POST['cpf']) && (isset($_POST['senha'])) && (isset($_POST['confima'])) && (isset($_POST['nome'])) && (isset($_POST['permissao'])))
    {
        ...
        {
            echo "<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=https://termonline.com.br/admin/addUsuario.php'>
        ...
        else
        {
            ...
            {
                echo "
            <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=https://termonline.com.br/admin/addUsuario.php'>
